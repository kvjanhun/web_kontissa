import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, ref, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, unref, Suspense, nextTick, mergeProps, Fragment, watch, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/h3/dist/index.mjs";
import { shouldHydrate, defineStore, storeToRefs, setActivePinia, createPinia } from "pinia";
import { defu } from "/Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/about-B0Ltgr1U.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$9 || {},
    component: () => import("./_nuxt/admin-iLSzzwzd.js")
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$8 || {},
    component: () => import("./_nuxt/index-B3TpyDW1.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$7 || {},
    component: () => import("./_nuxt/login-CANAQbyH.js")
  },
  {
    name: "contact",
    path: "/contact",
    meta: __nuxt_page_meta$6 || {},
    component: () => import("./_nuxt/contact-DXbSgFNz.js")
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/_...slug_-74uzxZeM.js")
  },
  {
    name: "sanakenno",
    path: "/sanakenno",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/sanakenno-BL0jKzWC.js")
  },
  {
    name: "recipes-new",
    path: "/recipes/new",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/new-BBMQhN-_.js")
  },
  {
    name: "recipes",
    path: "/recipes",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/index-tLlAB6c6.js")
  },
  {
    name: "recipes-slug",
    path: "/recipes/:slug()",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/_slug_-dQIpVxCD.js"),
    children: [
      {
        name: "recipes-slug-edit",
        path: "edit",
        meta: __nuxt_page_meta$1 || {},
        component: () => import("./_nuxt/edit-CwCKk62k.js")
      }
    ]
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-C_uaB0rx.js").then((m) => m.default || m)),
  standalone: defineAsyncComponent(() => import("./_nuxt/standalone-BQ_TM55x.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-iLR9SE0Z.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BhyBcswN.js"));
