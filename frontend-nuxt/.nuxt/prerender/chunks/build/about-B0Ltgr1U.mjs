import { computed, ref, unref, mergeProps, useSSRContext } from 'file:///Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderStyle, ssrInterpolate, ssrRenderComponent } from 'file:///Users/erezac/Projects/web_kontissa/frontend-nuxt/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.section.section_type === "quote") {
        ...
        _push(`<article${ssrRenderAttrs(mergeProps({
          ...
          id: __props.section.slug,
          style: { background: "var(--color-bg-secondary)", border: "1px solid var(--color-border)" }
        }, _attrs))} data-v-077997d1><div class="px-5 pt-4 pb-4" data-v-077997d1><h2 class="text-xl font-medium m-0 pb-1" data-v-077997d1>${ssrInterpolate(__props.section.title)}</h2><div style="${ssrRenderStyle({ width: "3rem", height: "2px", background: "var(--color-accent, #ff643e)", opacity: 0.6 })}" data-v-077997d1></div></div><div class="section-content px-5 pb-4" data-v-077997d1>${(_a = __props.section.content) != null ? _a : ""}</div></article>`);
      }
    };
  }
};
...
//# sourceMappingURL=about-B0Ltgr1U.mjs.map
