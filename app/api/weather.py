...
WAWA_MAP = {
    ...
    5: ("Haze", "Utua"),
    10: ("Mist", "Utua"),
    20: ("Recent precipitation", "Sadetta aiemmin"),
    21: ("Rain", "Sadetta"),
    22: ("Snow", "Lumisadetta"),
    23: ("Rain and snow", "Räntää"),
    24: ("Freezing rain", "Jäätävää sadetta"),
    25: ("Rain showers", "Sadekuuroja"),
    26: ("Snow showers", "Lumikuuroja"),
    27: ("Hail showers", "Raekuuroja"),
    (30, 39): ("Thunder", "Ukkosta"),
    (40, 49): ("Fog", "Sumua"),
